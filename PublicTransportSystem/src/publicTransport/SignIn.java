...
public boolean checkInfo(String name, String pass) throws PasswordException {
    Info b = new Info();
    ...
    throw new PasswordException("Wrong Username or Password");
}


public void actionPerformed(ActionEvent e) {
    String name = userfield.getText();
    String pass = new String(passwordfield.getPassword()); // Get password as a string
